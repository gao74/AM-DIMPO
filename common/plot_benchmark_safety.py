...
##############################
easy_mappo_0 = np.load('../results/mappo_30000_easy' + episode_rewards)
# easy_mappo_2000 = np.load('../results/mappo_30000_easy' + episode_rewards)
# easy_mappo_2021 = np.load('../results/mappo_30000_easy' + episode_rewards)
